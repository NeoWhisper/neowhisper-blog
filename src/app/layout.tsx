...
export default async function RootLayout({
  ...
  return (
    <html lang={lang} dir={dir} className={`${outfit.variable} ${geistMono.variable}`}>
      ...
      <body className="font-sans antialiased min-h-screen flex flex-col bg-gray-50 dark:bg-[#0a0a0e] bg-grain cinematic-vignette overflow-x-hidden selection:bg-purple-500/30">
