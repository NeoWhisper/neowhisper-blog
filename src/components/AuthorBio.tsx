  ...
  return (
    ...
    >
      <div className="p-6 sm:p-8">
        ...
        >
          ...
          <div className={isRTL ? "text-right" : "text-left"}>
            ...
            <div className={`flex gap-3 ${isRTL ? "flex-row-reverse" : ""}`}>
              ...
              {/*
                To add more social links (Twitter/X, LinkedIn, etc.):
                1. Copy the Link block above
                2. Update href to your profile URL
                3. Update aria-label
                4. Replace the SVG with the appropriate icon

                Example for Twitter/X:
                <Link href="https://x.com/yourhandle" target="_blank" rel="noopener noreferrer"
                  className="text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors"
                  aria-label="Twitter">
        ...
        {/* Bio */}
        <p
          className={`text-base leading-relaxed text-gray-700 dark:text-gray-300 mb-4 ${isRTL ? "text-right" : "text-left"}`}
        >
          {text.bio}
        </p>
        ...
        {/* Expertise Tags */}
        <p
          className={`text-sm text-gray-600 dark:text-gray-400 mb-6 ${isRTL ? "text-right" : "text-left"}`}
        >
          {text.expertise}
        </p>
        ...
        <div>
          <h4
            className={`text-lg font-bold text-gray-900 dark:text-white mb-4 ${isRTL ? "text-right" : "text-left"}`}
          >
            {text.whyTrust}
          </h4>
          <ul
            className={`space-y-3 mb-6 ${isRTL ? "text-right" : "text-left"}`}
          >
            {text.trustPoints.map((point, index) => (
              <li
                key={index}
                className={`flex items-start gap-3 text-sm text-gray-700 dark:text-gray-300 ${isRTL ? "flex-row-reverse" : ""}`}
              >
                <svg
