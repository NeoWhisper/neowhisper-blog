                    ...
                    <header className={`px-6 sm:px-12 py-8 border-b border-gray-200 dark:border-gray-700 ${isRTL ? 'text-right' : 'text-left'}`}>
                        ...
                        <div className={`flex flex-wrap items-center gap-3 ${isRTL ? 'flex-row-reverse' : ''}`}>
                            ...
                            {category && (
                                <>
                                    <span className="text-gray-400">•</span>
                                    <span className="inline-block text-sm font-medium text-blue-600 dark:text-blue-400 bg-blue-100/50 dark:bg-blue-900/20 px-4 py-2 rounded-full border border-blue-200/50 dark:border-blue-800/30">
                                        {category}
                                    </span>
                                </>
                            )}
