...
- [1) GPT-5.4 Moved the Baseline for Agentic Work](#1-gpt-5-4-moved-the-baseline-for-agentic-work)
- [2) AI-Enabled Vulnerability Discovery Is No Longer Theoretical](#2-ai-enabled-vulnerability-discovery-is-no-longer-theoretical)
- [3) The AI Infrastructure Race Is Now About Cost-per-Token at Scale](#3-the-ai-infrastructure-race-is-now-about-cost-per-token-at-scale)
- [What to Do in the Next 30 Days](#what-to-do-in-the-next-30-days)
