...
- [The Problem: CSP Blocks Everything Google Needs](#the-problem-csp-blocks-everything-google-needs)
...
const connectSrc = [
  ...
  "https://ep1.adtrafficquality.google", // AdSense SODAR endpoints
...
_Note: Avoid broad wildcards when possible. Add new domains only after confirming a real console error._

</Step>

<Step number="4" title="Final Clean Configuration">

Here is the final configuration in `src/proxy.ts` that handles both Development (HMR) and Production (AdSense):
