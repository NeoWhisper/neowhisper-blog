...
category: "Next.js"
coverImage: "/images/debugging-playbook-cover.png"
author:
  name: "NeoWhisper"
...
- [Why "Local OK, Production Broken" Happens](#why-local-ok-production-broken-happens)
- [Step 1: Measure Blast Radius with Route Probes](#step-1-measure-blast-radius-with-route-probes)
- [Step 2: Reproduce in True Production Mode Locally](#step-2-reproduce-in-true-production-mode-locally)
- [Step 3: Suspect Top-Level Imports in Failing Route Modules](#step-3-suspect-top-level-imports-in-failing-route-modules)
- [Step 4: Prevent Cascading Failures in Error Paths](#step-4-prevent-cascading-failures-in-error-paths)
- [Step 5: Add Deployment Smoke Checks](#step-5-add-deployment-smoke-checks)
