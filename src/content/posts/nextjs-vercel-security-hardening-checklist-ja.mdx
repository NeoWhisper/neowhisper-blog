...
- [1. まず攻撃面を明文化する](#1-まず攻撃面を明文化する)
- [2. CSPは段階的に導入する](#2-cspは段階的に導入する)
- [3. robots/sitemap の CORS を放置しない](#3-robots-sitemap-の-cors-を放置しない)
- [4. 互換性対応と本体セキュリティを分離する](#4-互換性対応と本体セキュリティを分離する)
- [5. 信頼ページを運用資産として管理する](#5-信頼ページを運用資産として管理する)
- [6. デプロイ後のセキュリティスモークテスト](#6-デプロイ後のセキュリティスモークテスト)
- [7. Next.js + Vercel での実用ベースライン](#7-next-js-vercel-での実用ベースライン)
- [最終チェック](#最終チェック)
