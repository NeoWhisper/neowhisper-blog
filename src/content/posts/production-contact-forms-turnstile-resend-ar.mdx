...
- [المشكلة مع نماذج الاتصال "البسيطة"](#المشكلة-مع-نماذج-الاتصال-البسيطة)
- [لماذا Cloudflare Turnstile + Resend؟](#لماذا-cloudflare-turnstile-resend)
  - [التحسين التدريجي](#التحسين-التدريجي)
  - [تعامل محدد مع الأخطاء](#تعامل-محدد-مع-الأخطاء)
